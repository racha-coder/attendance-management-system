...
# Create a window as a main frame
window = tk.Tk()
...
def manually_fill():
    ...
    sb.geometry("580x320")
    sb.configure(background="gray70")
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                ...
                csv_name = (
                    os.curdir() + "/attendance/manualAttendance/DB_table_name.csv"
                )
                ...
                def attf():
                    ...
                    subprocess.Popen(
                        r"explorer /select,"
                        + os.curdir()
                        + "/attendance/manualAttendance/-------Check atttendance-------"
                    )
        ...
        try:
            ...
            while True:
                ...
                for x, y, w, h in faces:
                    ...
                    print("Image Saved For Enrollment : ")
